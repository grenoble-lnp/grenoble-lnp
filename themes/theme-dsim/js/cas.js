    ...
    $(document).ready(function () {
        ...
        $revealpassword.mousedown(function (ev) {
            if($('.pwd').attr('type')!='text') {
                ...
                $(".reveal-password-icon").removeClass("icon icon-eye").addClass("icon icon-eye-blocked");
            } else {
                $('.pwd').attr('type', 'password');
                // $(".reveal-password-icon").removeClass("mdi mdi-eye-off").addClass("mdi mdi-eye");
                $(".reveal-password-icon").removeClass("icon icon-eye-blocked").addClass("icon icon-eye");
            }
            ev.preventDefault();
        });
